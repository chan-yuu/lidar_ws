...
public:
    ...
    ros::Publisher _pub_cluster_visualize_markers, _pub_objects;
...
private:
    ...
    void publishDetectedObjects(const autoware_msgs::CloudClusterArray &in_clusters, autoware_msgs::DetectedObjectArray &detected_objects, perception_msgs::PerceptionObjects &object);
    ...
    void cicv_location_callback(const perception_msgs::PerceptionLocalization::ConstPtr& msg);
